...
int main (int argc, char* args[]) {
    unsigned int cdTick,ticks,followTicks,walkTick,difficultyTick,bulletsTicks;
    unsigned int spawnInterval = 1000,cooldownTime = 200,followInterval = 100, walkCd=20,difficultyInterval=LEVEL,bulletInterval=5;
    ...
    while (1) {
        ...
        if(SDL_GetTicks() >= bulletsTicks+bulletInterval) {
            moveBullets(bullets);
